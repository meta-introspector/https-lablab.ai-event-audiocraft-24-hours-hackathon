...
setup(
    ...
    entry_points="""
    [console_scripts]
    emojintrospector=emojintrospector.cli:cli
    """,
    ...
    url= 'https://github.com/jmikedupont2/emojintrospector',
    download_url=(
        f'https://github.com/jmikedupont2/'
        f'emojintrospector/archive/{version}.tar.gz'
    ),
    keywords=[
